...
export const PER_UNIT_ROYALTY_RANGE = "$280–$470/unit";

export const MODEL_ASSUMPTIONS_LINE =
  "Model: $280–470/unit (~1–2% of unit value) · ~50K units/partner/yr · ~700K addressable shipments/yr · ~90% royalty margin · 15–20× revenue multiple";
