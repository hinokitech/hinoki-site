...
const ARC_STATUS_LANES = [
  ...
  },
  {
    ...
    filled: 2,
    body: "Sub-millisecond latency and per-correction energy figures are modeled from peer-reviewed research and Phase 1 work, and validated as achievable by our advisors (incl. Dr. Cédric Caremel) and CTO. Physical measurement is precisely what this raise funds.",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    status: "Discovery and LOIs forming",
    filled: 2,
    body: "The LOIs matter because they validate that customers face this problem and want the solution — not revenue, but demand. LOI in progress with a Tokyo tactile-sensing partner; gripper-OEM and elder-care discovery active.",
  },
] as const;
...
export function ArcStatusSlide() {
  return (
    <Slide align="start" dense>
      ...
      <SlideFooter pageLabel="30 · Where Arc is today" />
    </Slide>
  );
}
