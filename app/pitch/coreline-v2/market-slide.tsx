...
function MarketLayerRow({
  ...
  return (
    ...
    >
      <div
        className={`font-mono uppercase tracking-[0.14em] ${phaseClass}${
          step === 2 ? " mt-5" : ""
        }`}
      >
        {phase}
    ...
    <Slide align="start">
      ...
      <div className="mt-auto max-w-[1640px] shrink-0 rounded-[10px] border-2 border-accent bg-accent-subtle px-10 py-7">
        <p className="text-[24px] font-light leading-[1.45] tracking-[-0.015em] text-fg-primary">
          Slip is just the entry point. Grip, balance, impact safety — every
          fast physical correction a robot needs is the same architecture.
        </p>
      </div>
