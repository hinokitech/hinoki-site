...
// Speaker notes (not rendered on slide):
// "We sell a real thing from day one — Arc as a module that drops into a partner's
// gripper, ten to thirty million yen, live in under two months. That earns the embed,
// where Arc ships inside their reference design with per-unit pricing. And once volume
// is there, the architecture itself becomes licensable IP. Every stage is revenue,
// every stage embeds us deeper — the sub-millisecond data nobody else can capture,
// the blueprint lock-in, the physical efficiency. We're not betting the business on
// licensing. We're earning the right to license it."
  ...
  },
  {
    ...
    body: (
      <>
        ...
        partner (NRE + initial production units)
      </>
    ),
    step: 1 as const,
  },
