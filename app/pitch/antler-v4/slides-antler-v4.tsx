...
// =====================================================================
//  HINOKI — ANTLER IC DECK V4 (source of truth)
//
...
//    25  Competition — Reflex is fragmented; nobody owns the layer.
...
//    30  Thank You
//
//  Appendix slides archived in slides-antler-v4-appendix.tsx (not in live deck).
//
      ...
      <div className="grid flex-1 grid-cols-[minmax(0,1fr)_minmax(0,620px)] items-stretch gap-12">
        <div className="flex min-h-0 flex-col">
          ...
          <div className="mt-8 flex flex-1 flex-col py-4">
            <div className="flex flex-1 items-center border-l-2 border-accent/40 pl-7">
              <p className="text-[42px] font-light leading-[1.15] tracking-[-0.015em] text-fg-primary">
                Every site needs tuning, field engineering, support.
              </p>
            </div>
            <div className="flex flex-1 items-center border-l-2 border-accent/40 pl-7">
              <p className="text-[42px] font-light leading-[1.15] tracking-[-0.015em] text-fg-primary">
        ...
        <div className="flex min-h-0 flex-col">
          ...
          <div className="mt-8 flex flex-1 flex-col">
            ...
            <p className="pb-2 text-[36px] font-light leading-[1.35] tracking-[-0.015em] text-fg-secondary">
              Today&rsquo;s stack responds too late.
            </p>
          </div>
        </div>
...
const ASK_MILESTONES = [
  {
    range: "0–3 months",
    body: "Closed-loop validation rig live. Benchmark Arc vs. conventional baseline with reproducible sub-millisecond data. Initial IP filing in.",
  },
  {
    range: "3–6 months",
    body: "Validation data in hand with 1–2 Japanese gripper OEMs. First paid pilot LOI secured.",
  },
  {
    range: "6–9 months",
    body: "Raise professional seed on benchmark data, paid pilot traction, and IP position.",
  },
] as const;
...
const CAPITAL_PIPELINE_GROUPS = [
  {
    label: "Active",
    items: "Sony Innovation Fund · Coreline (interviewing)",
  },
  {
    label: "Applied",
    items:
  ...
  return (
    <Slide align="start" dense>
      ...
      <h2 className="max-w-[1640px] text-[64px] font-light leading-[1.06] tracking-[-0.022em] text-fg-primary">
        Antler capital unlocks the benchmark that unlocks the next round.
      </h2>
      ...
      <div className="mt-6 flex min-h-0 flex-1 flex-col">
        ...
        <div className="mt-6 max-w-[1640px] shrink-0 rounded-[10px] border-2 border-accent bg-accent-subtle px-10 py-6">
          <p className="text-[24px] font-light leading-[1.45] tracking-[-0.015em] text-fg-primary">
            <span className="font-semibold text-accent">The Ask:</span> ~$150K
            from Antler · stacked with ~¥50M non-dilutive in pipeline · combined
            runway to validation milestone.
          </p>
        </div>
        ...
        <div className="mt-6 max-w-[1640px] shrink-0">
          ...
          <div className="mt-3 flex flex-col divide-y divide-border/60">
            {CAPITAL_PIPELINE_GROUPS.map((group) => (
              <CapitalPipelineRow key={group.label} {...group} />
            ))}
          </div>
        </div>

        <div className="mt-auto max-w-[1640px] shrink-0 pt-6">
          <p className="text-[24px] font-light leading-[1.45] tracking-[-0.015em] text-fg-primary">
            One measurable reflex loop becomes the foundation for reaction
...
//  Appendix: slides-antler-v4-appendix.tsx
// =====================================================================
export const SLIDES_ANTLER_V4_MAIN: Array<() => React.JSX.Element> = [
  CoverSlide,
  HaveYouSeenMeSlide,
  Bottleneck1Slide,
  Bottleneck2Slide,
...
export const SLIDES_ANTLER_V4 = SLIDES_ANTLER_V4_MAIN;

export { APPENDIX_SLIDES_ANTLER_V4 } from "./slides-antler-v4-appendix";
