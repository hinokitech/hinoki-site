        ...
        <div className="flex min-h-0 flex-col">
          ...
          <div className="mt-10 flex flex-1 flex-col justify-center gap-9">
            <SolutionRow label="What Arc does">
              A reflex layer that drops into existing grippers and sensors —
              no robot redesign. Caps contact force and arrests slips locally,
              in <span className="font-semibold text-accent">&lt;0.5 ms</span>.
            </SolutionRow>

            <SolutionRow label="Result">
              The cage-free safety layer McKinsey says is missing — so
              humanoids can finally scale.
            </SolutionRow>
          </div>
        </div>
