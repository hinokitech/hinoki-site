...
import { Slide, SlideFooter, DeckSlideHeader, DECK_GTM_INDUSTRIES } from "./slides";
import {
  MicroLabel,
  ...
  return (
    <Slide align="start">
      <DeckSlideHeader
        ...
        title={
          <>
            Bottom-up: start where the{" "}
            <span className="text-gradient-logo">wedge is closest.</span>
          </>
        }
        subtitle="Multi-tiered B2B commercialization — end-effector OEMs to industrial conglomerates."
      ...
      <div className="mt-5 max-w-[1640px] shrink-0 border-t border-border pt-5">
        ...
        <ul className="mt-3 columns-2 gap-x-12 text-[18px] leading-[1.65] text-fg-primary">
          {DECK_GTM_INDUSTRIES.map((industry) => (
      ...
      <SlideFooter pageLabel="08 · Go-to-Market" />
    </Slide>
  );
}
