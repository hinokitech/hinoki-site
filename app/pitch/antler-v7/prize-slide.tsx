...
const PRIZE_LAYERS = [
  {
    ...
    bodyClass: "text-[20px] font-normal leading-[1.45] tracking-[-0.01em] text-fg-primary",
    step: 0 as const,
  },
  {
    ...
    bodyClass: "text-[20px] font-light leading-[1.45] tracking-[-0.01em] text-fg-secondary",
    step: 1 as const,
  },
  {
    ...
    bodyClass: "text-[20px] font-light leading-[1.45] tracking-[-0.01em] text-fg-secondary/90",
    step: 2 as const,
  },
] as const;
...
export function PrizeSlide() {
  return (
    <Slide align="start">
      ...
      <SlideFooter pageLabel="24 · The Prize" />
    </Slide>
  );
}
