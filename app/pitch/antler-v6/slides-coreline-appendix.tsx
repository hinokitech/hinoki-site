...
// =====================================================================
//  CORELINE DECK — APPENDIX (archived, not in live deck)
//
//  Re-attach when needed:
//    import { APPENDIX_SLIDES_CORELINE } from "./slides-coreline-appendix";
//    slides={[...SLIDES_CORELINE_MAIN, ...APPENDIX_SLIDES_CORELINE]}
//
//    A1  Vision
//    A2  Defensibility
//    A3  First Benchmark
...
export const APPENDIX_SLIDES_CORELINE: Array<() => React.JSX.Element> = [
  VisionSlide,
  DefensibilitySlide,
